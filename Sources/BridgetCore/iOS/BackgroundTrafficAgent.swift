//  BackgroundTrafficAgent.swift (iOS-specific)
//  BridgetCore
//
//  This file is only compiled for iOS targets. All UIKit and iOS-specific code goes here.
//  See the cross-platform stub in Sources/BridgetCore/BackgroundTrafficAgent.swift for non-iOS platforms.
